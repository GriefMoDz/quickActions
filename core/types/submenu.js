...
module.exports = (id, key, plugin, setting, name, main) => {
  ...
  for (const childKey in setting.children) {
    ...
    switch (setting.type) {
      case 'button':
        child = require('./button').bind(this, id, childKey, setting, name)(main);
      ...
      case 'submenu':
        ...
        break;
      case 'slider':
        child = require('./slider').bind(this, id, childKey, setting)(main);

        break;
      default:
        child = require('./checkbox').bind(this, id, childKey, setting)(main);
